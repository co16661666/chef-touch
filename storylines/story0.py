...
class Story0:
    def __init__(self, initTagPosDict):
        ...
        self.lettuce = Ingredient(6, "Lettuce", initTagPosDict[6], 0, 3)
        self.tomato = Ingredient(7, "Tomato", initTagPosDict[7], 0, 3)
        self.mixPlate = MixPlate(5, "Mix Plate", initTagPosDict[5], 0, 1, self.lettuce, self.tomato)

        self.complete = False

    def update(self, tagPosDict):
        self.lettuce.position = tagPosDict[6]
        self.tomato.position = tagPosDict[7]
        self.mixPlate.position = tagPosDict[5]
